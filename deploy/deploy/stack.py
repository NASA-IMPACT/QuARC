...
class AppStack(core.Stack):
    ...
    def __init__(self, scope, construct_id, **kwargs):
        ...
        pyQuARC_layer = lambda_.LayerVersion(self, f"{construct_id}-pyQuARC-layer",
        ...
        runner = lambda_.Function(self, f"{construct_id}-runner",
        ...
        api = apigateway.LambdaRestApi(self, f"{construct_id}-api",
            handler=runner,
